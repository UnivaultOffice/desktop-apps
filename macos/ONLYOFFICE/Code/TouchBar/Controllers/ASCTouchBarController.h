...
static NSString * const kCreationButtonIdentifier  = @"com.univaultoffice.touchbar.button.new.%@";
static NSString * const kStartPageButtonIdentifier = @"com.univaultoffice.touchbar.button.startpage";
