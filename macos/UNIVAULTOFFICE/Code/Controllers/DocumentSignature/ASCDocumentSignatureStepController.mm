...
//  UNIVAULTOFFICE
//
//  Created by Alexander Yuzhin on 16/04/2025.
    ...
    switch (nCertValue) {
        case OPEN_SSL_WARNING_ERR: {
            [self showErrorWithTitle:NSLocalizedString(@"Cannot open file of Digital Signature", nil)
                            subtitle:NSLocalizedString(@"UNIVAULTOFFICE can not open the Digital Signature file. Try opening another file.", nil)];
            break;
        }
    ...
    switch (nCertValue) {
        case OPEN_SSL_WARNING_ERR: {
            [self showErrorWithTitle:NSLocalizedString(@"Cannot open file of Private Key", nil)
                            subtitle:NSLocalizedString(@"UNIVAULTOFFICE can not open the Private Key. Try opening another file.", nil)];
            break;
        }
        case OPEN_SSL_WARNING_PASS: {
