...
- (IBAction)onUnivaultofficeButton:(id)sender {
    if (_delegate && [_delegate respondsToSelector:@selector(onUnivaultofficeButton:)]) {
        [_delegate onUnivaultofficeButton:sender];
    }
}
