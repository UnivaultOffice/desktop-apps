...
//  UNIVAULTOFFICE
//
//  Created by Alexander Yuzhin on 02/01/2025.
...
static NSTouchBarCustomizationIdentifier const kScrubberCustomizationIdentifier = @"com.univaultoffice.touchbar.scrubberViewController";
static NSTouchBarItemIdentifier const kScrubbedItemIdentifier = @"com.univaultoffice.touchbar.item.scrubber";
static NSTouchBarItemIdentifier const kStartPageItemIdentifier = @"com.univaultoffice.touchbar.item.startpage";
static NSTouchBarItemIdentifier const kNewItemsItemIdentifier = @"com.univaultoffice.touchbar.item.newItems";
