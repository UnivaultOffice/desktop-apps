l10n.it_IT = {
    welWelcome: 'Benvenuti su UNIVAULTOFFICE Desktop Editors!',
    welDescr: 'Lavora ai documenti offline o collega la suite al tuo cloud: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crea UNIVAULTOFFICE cloud',
    ...
    portalEmptyAdv1: 'Non hai ancora un account cloud? Vai online con UNIVAULTOFFICE Cloud Service e prova le capacità di collaborazione gratis.',
    ...
    linkCreatePortal: 'Crea UNIVAULTOFFICE cloud',
    ...
    loginNoteAssignPhone: 'L\'autenticazione a due fattori è abilitata per fornire ulteriore sicurezza del UNIVAULTOFFICE cloud. Inserisci il tuo numero di cellulare per continuare a lavorare sul ufficio cloud. Il numero di cellulare deve essere inserito utilizzando un formato internazionale con prefisso internazionale.',
    ...
    emptySlide3Text: 'Archivia i tuoi documenti nel cloud UNIVAULTOFFICE e accedili in qualsiasi momento da qualsiasi luogo.',
