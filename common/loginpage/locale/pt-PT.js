l10n.pt_PT = {
    ...
    welDescr: 'Trabalhe em documentos offline ou ligue-se à sua nuvem: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    welNeedHelp: 'Precisa de ajuda? Visite o nosso $1.',
    textHelpCenter: 'Central de Ajuda',
    btnConnect: 'Ligar',
    textHavePortal: 'Já utiliza uma nuvem?',
    btnCreatePortal: 'Crie uma nuvem no UNIVAULTOFFICE',
    ...
    portalEmptyAdv1: 'Ainda não tem uma conta com nuvem? Obtenha uma gratuitamente através do Serviço de Nuvem da UNIVAULTOFFICE e experimente as suas funcionalidades para colaboração de forma gratuita.',
    ...
    linkCreatePortal: 'Crie uma nuvem na UNIVAULTOFFICE',
    ...
    emptySlide3Text: 'Armazene os seus documentos na nuvem do UNIVAULTOFFICE e aceda à mesma em qualquer altura, a partir de qualquer lugar.',
