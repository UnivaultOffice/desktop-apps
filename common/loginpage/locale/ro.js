l10n.ro = {
    welWelcome: 'Bine ați venit la UNIVAULTOFFICE Desktop Editors!',
    welDescr: 'Lucrați la documente offline sau conecta suitați suitã la cloud: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crearea unui cont UNIVAULTOFFICE cloud',
    ...
    portalEmptyAdv1: 'Încã nu aveți un cont Cloud? Lucrați online cu servicii cloud UNIVAULTOFFICE ți <br />încercați funcțiile de colaborare gratuit.',
    ...
    linkCreatePortal: 'Crearea unui cont UNIVAULTOFFICE cloud',
    ...
    loginNoteAssignPhone: 'Autentificarea cu doi factori este activatã ca o mãsurã suplimentarã de securitate pentru UNIVAULTOFFICE cloud. Intra-i numãrul de telefon dvs vă sã puteţi continua lucrul în oficiul cloud. Numãrul de telefon mobil trebuie introdus în format internaþional cu prefixul de țarã.',
    ...
    emptySlide3Text: 'Stocați-vă documentele în UNIVAULTOFFICE cloud și le accesati de oriunde, oricând.',
