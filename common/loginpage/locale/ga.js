l10n.ga = {
    welWelcome: 'Fáilte chuig UNIVAULTOFFICE Eagarthóirí Deisce!',
    welDescr: 'Oibrigh ar dhoiciméid as líne nó ceangail an tsraith le do scamall: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Cruthaigh scamall UNIVAULTOFFICE',
    ...
    portalEmptyAdv1: 'Nach bhfuil cuntas scamall agat fós? Téigh ar líne le UNIVAULTOFFICE Cloud Service agus <br /> bain triail as cumais chomhoibritheacha saor in aisce.',
    ...
    linkCreatePortal: 'Cruthaigh scamall UNIVAULTOFFICE',
    ...
    loginNoteAssignPhone: 'Cumasaítear an fíordheimhniú dhá fhachtóir chun slándáil scamall UNIVAULTOFFICE a sholáthar. Cuir isteach d’uimhir fón póca chun leanúint ar aghaidh ag obair ar an oifig scamall. Ní mór uimhir fón póca a iontráil ag úsáid formáid idirnáisiúnta le cód tíre.',
    ...
    emptySlide3Text: 'Déan do chuid doiciméad a stóráil sa scamall UNIVAULTOFFICE agus rochtain a fháil orthu am ar bith, ó áit ar bith.',
