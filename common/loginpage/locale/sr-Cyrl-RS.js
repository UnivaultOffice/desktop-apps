l10n.sr_Cyrl_RS = {
    welWelcome: 'Добро дошли у UNIVAULTOFFICE Десктоп Уређиваче!',
    welDescr: 'Радите на документима офлајн или конектујте пакет на свој облак: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Креирај UNIVAULTOFFICE облак',
    ...
    portalEmptyAdv1: 'Још увек немате облак рачун? Идите онлајн са UNIVAULTOFFICE Облак сервисом и <br /> покушајте сарађивачке способности бесплатно.',
    ...
    linkCreatePortal: 'Креирај UNIVAULTOFFICE облак',
    ...
    loginNoteAssignPhone: 'Двофакторска аутентикација је омогућена да обезбеди додатну UNIVAULTOFFICE облак безбедност. Унесите свој број телефона да наставите рад на облак офис-у. Број мобилног телефона мора бити унет користећи интернационални формат са кодом државе.',
    ...
    emptySlide3Text: 'Складишти своје документе у UNIVAULTOFFICE облаку и приступи им било када, са било ког места.',
