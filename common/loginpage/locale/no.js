l10n.no = {
    welWelcome: 'Velkommen til UNIVAULTOFFICE redigeringsprogrammer for PC!',
    welDescr: 'Arbeid med dokumenter offline eller koble suiten til din skykonto: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Lag en UNIVAULTOFFICE-sky',
    ...
    portalEmptyAdv1: 'Har du ikke konto enda? Koble deg til nettet med UNIVAULTOFFICE skytjeneste og <br />prøv samarbeidsfunksjonene gratis.',
    ...
    linkCreatePortal: 'Sett opp en UNIVAULTOFFICE-sky',
    ...
    loginNoteAssignPhone: 'To-faktor-godkjenning er aktivert for å gi ekstra skysikkerhet for UNIVAULTOFFICE. Skriv inn mobilnummeret ditt for å fortsette å arbeide på skykontoret. Mobiltnummer må angis med et internasjonalt format med landskode.',
    ...
    emptySlide3Text: 'Lagre dokumentene dine i UNIVAULTOFFICE-skyen og få tilgang til dem når som helst, fra hvor som helst.',
