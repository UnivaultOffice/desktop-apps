l10n.pt_BR = {
    welWelcome: 'Bem-vindo ao UNIVAULTOFFICE Desktop Editors!',
    welDescr: 'Trabalhe em documentos offline ou conecte-se à sua nuvem: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    welNeedHelp: 'Precisa de ajuda? Visite nossa $1.',
    textHelpCenter: 'Central de Ajuda',
    btnConnect: 'Conectar',
    textHavePortal: 'Já usa o nuvem?',
    btnCreatePortal: 'Criar UNIVAULTOFFICE na nuvem',
    ...
    portalEmptyAdv1: 'Ainda não tem uma conta? Experimente colaboracão na nuvem do UNIVAULTOFFICE gratuitamente.',
    ...
    linkCreatePortal: 'Criar UNIVAULTOFFICE na nuvem',
    ...
    loginNoteAssignPhone: 'A autenticação de dois fatores está habilitada para fornecer segurança adicional ao nuvem do UNIVAULTOFFICE. Insira o seu número de celular para continuar trabalhando no escritório na nuvem. O número de telefone deve ser inserido usando um formato internacional com o código do país.',
    ...
    emptySlide3Text: 'Armazene seus documentos na nuvem do UNIVAULTOFFICE e acesse-os a qualquer momento, de qualquer lugar.',
