l10n.fi = {
    welWelcome: 'Tervetuloa UNIVAULTOFFICE Työpöytä Editoriin!',
    welDescr: 'Työskentele ilman verkkoyhteyttä tai yhdistä pilveesi: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Luo UNIVAULTOFFICE pilvi',
    ...
    portalEmptyAdv1: 'Eikö sinulla ole vielä pilveä? Ota yhteys verkkoon UNIVAULTOFFICEN pilvipalvelulla ja <br />kokeile yhteistyö-mahdollisuuksia ilmaiseksi.',
    ...
    linkCreatePortal: 'Luo UNIVAULTOFFICE pilvi',
    ...
    loginNoteAssignPhone: 'Kaksi-vaiheinen tunnistus on otettu käyttöön, tuomaan lisäturvaa UNIVAULTOFFICEN pilveen. Syötä puhelinnumerosi, jatkaaksesi työskentelyä pilvi-officessa. Puhelinnumero tulee syöttää käyttäen kansainvälistä muotoa maatunnuksella.',
    ...
    emptySlide3Text: 'Säilö dokumenttisi UNIVAULTOFFICEN pilveen ja käytä niitä million tahansa, missä tahansa.',
