l10n.ru = {
    welWelcome: 'Добро пожаловать в UNIVAULTOFFICE!',
    welDescr: 'Работайте с документами офлайн или подключитесь к облаку: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Создать облако UNIVAULTOFFICE',
    ...
    portalEmptyAdv1: 'Еще нет облачного аккаунта? Перейдите в онлайн-режим с облачным сервисом UNIVAULTOFFICE и попробуйте возможности совместного редактирования бесплатно.',
    ...
    linkCreatePortal: 'Создать облако UNIVAULTOFFICE',
    ...
    loginNoteAssignPhone: 'Для обеспечения повышенной безопасности в облаке UNIVAULTOFFICE включена двухфакторная аутентификация. Для продолжения работы в облачном офисе введите ваш номер мобильного телефона. Номер мобильного телефона необходимо ввести в международном формате с кодом страны.',
    ...
    emptySlide3Text: 'Храните документы в облаке UNIVAULTOFFICE и получайте к ним доступ в любое время, из любой точки мира.',
    ...
    reportsMissingText: 'Положите папку reports-ui с файлом reports.key внутри в папку установки и перезапустите приложение.',
}
