l10n.de = {
    welWelcome: 'Willkommen in UNIVAULTOFFICE Desktop-Editoren!',
    welDescr: 'Arbeiten Sie offline an Dokumenten oder verbinden Sie die Suite mit Ihrer Cloud: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'UNIVAULTOFFICE-Cloud erstellen',
    ...
    portalEmptyAdv1: 'Haben Sie noch kein Cloud-Konto? Wechseln Sie zum Onlinemodus mit dem UNIVAULTOFFICE Cloud Service und testen Sie die Möglichkeiten zur Zusammenarbeit  kostenlos.',
    ...
    linkCreatePortal: 'UNIVAULTOFFICE-Cloud erstellen',
    ...
    loginNoteAssignPhone: 'Die Zwei-Faktor-Authentifizierung ermöglicht zusätzliche UNIVAULTOFFICE Cloud Sicherheit. Geben Sie Ihre Handynummer ein, um die Arbeit am Cloud-Büro fortzusetzen. Die Handynummer muss in einem internationalen Format mit Ländervorwahl eingegeben werden.',
    ...
    emptySlide3Text: 'Speichern Sie Ihre Dokumente in der UNIVAULTOFFICE-Cloud und greifen Sie darauf jederzeit von überall zu.',
