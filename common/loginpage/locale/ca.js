l10n.ca = {
    welWelcome: 'Benvingut/da a UNIVAULTOFFICE Desktop Editors!',
    welDescr: 'Treballa sense connexió als teus documents o connecta la suite al teu núvol: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Crea un núvol UNIVAULTOFFICE',
    ...
    portalEmptyAdv1: 'Encara no tens un compte de núvol? Entra en línia amb UNIVAULTOFFICE Cloud Service i<br />prova les capacitats col·laboratives de franc.',
    ...
    linkCreatePortal: 'Crea un núvol UNIVAULTOFFICE',
    ...
    loginNoteAssignPhone: 'L\'autenticació de dos factors està habilitada per proporcionar seguretat addicional al núvol de UNIVAULTOFFICE. Introduïu el número de telèfon mòbil per continuar treballant a l\'oficina del núvol. Cal introduir el número de telèfon mòbil mitjançant un format internacional amb codi de país.',
    ...
    emptySlide3Text: 'Emmagatzema els teus documents al núvol UNIVAULTOFFICE i accedeix-hi en qualsevol moment, des de qualsevol lloc.',
