l10n.fr = {
    welWelcome: 'Bienvenue sur UNIVAULTOFFICE Desktop Editors !',
    welDescr: 'Travaillez avec vos documents en mode hors-connexion ou connectez la suite à votre Cloud : UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Créer un compte Cloud UNIVAULTOFFICE',
    ...
    portalEmptyAdv1: 'Vous n\'avez pas encore de compte Cloud ? Accéder en ligne avec UNIVAULTOFFICE et essayez les capacités de gestion collaborative gratuitement.',
    ...
    linkCreatePortal: 'Créer un compte Cloud UNIVAULTOFFICE',
    ...
    emptySlide3Text: 'Stockez vos documents dans UNIVAULTOFFICE Cloud et accedez-y depuis n\'importe où et à n\'importe quel moment.',
