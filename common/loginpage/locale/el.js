l10n.el = {
    welWelcome: 'Καλώς ήλθατε στο UNIVAULTOFFICE Desktop Editors!',
    welDescr: 'Εργαστείτε εκτός σύνδεσης με έγγραφα ή συνδέστε τη σουίτα στο cloud σας: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    ...
    btnCreatePortal: 'Δημιουργήστε ένα UNIVAULTOFFICE cloud',
    ...
    portalEmptyAdv1: 'Δεν έχετε λογαριασμό cloud; Συνδεθείτε στο διαδίκτυο με την υπηρεσία UNIVAULTOFFICE Cloud και <br /> δοκιμάστε τις δυνατότητες συνεργασίας δωρεάν.',
    ...
    linkCreatePortal: 'Δημιουργία ενός UNIVAULTOFFICE cloud',
    ...
    emptySlide3Text: 'Αποθηκεύστε τα έγγραφά σας στο UNIVAULTOFFICE cloud και αποκτήστε πρόσβαση σε αυτά ανά πάσα στιγμή και από οπουδήποτε.',
