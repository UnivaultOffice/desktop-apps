l10n.cs = {
    welWelcome: 'Vítejte v UNIVAULTOFFICE Desktop Editors!',
    welDescr: 'Práce na dokumentech offline nebo propojení sady do cloudu: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    welNeedHelp: 'Potřebujete pomoct? Navštivte naše $1.',
    textHelpCenter: 'Centrum nápovědy',
    btnConnect: 'Připojit',
    textHavePortal: 'Už používáte cloud?',
    btnCreatePortal: 'Vytvořit UNIVAULTOFFICE cloud',
    ...
    portalEmptyAdv1: 'Nemáte ještě cloud účet? Navštivte službu Cloud Service UNIVAULTOFFICE a vyzkoušejte možnosti spolupráce zdarma.',
    ...
    linkCreatePortal: 'Vytvořit UNIVAULTOFFICE cloud',
    ...
    loginNoteAssignPhone: 'K zajištění další bezpečnosti UNIVAULTOFFICE cloud je zapnuto dvoufaktorové ověřování. Zadejte své číslo mobilního telefonu, abyste mohli pokračovat v práci na kanceláře cloud. Číslo mobilního telefonu musí být zadáno pomocí mezinárodního formátu s kódem země.',
