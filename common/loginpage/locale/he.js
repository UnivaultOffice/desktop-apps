l10n.he = {
    welWelcome: 'ברוכים הבאים לעורכי שולחן העבודה של UNIVAULTOFFICE!',
    welDescr: 'לעבוד על מסמכים במצב לא מקוון או לחבר את החבילה לענן שלך: UNIVAULTOFFICE, ownCloud, Nextcloud.',
    welNeedHelp: 'צריך עזרה? בקר באתר שלנו ב-$1',
    textHelpCenter: 'מרכז עזרה',
    btnConnect: 'התחבר עכשיו',
    textHavePortal: 'כבר משתמשים בענן?',
    btnCreatePortal: 'צור ענן UNIVAULTOFFICE',
    ...
    portalEmptyAdv1: 'עדיין אין לך חשבון ענן? עבור למצב מקוון עם UNIVAULTOFFICE Cloud Service ו- <br />נסה יכולות שיתוף פעולה בחינם.',
    ...
    linkCreatePortal: 'צור ענן UNIVAULTOFFICE',
    ...
    loginNoteAssignPhone: 'האימות הדו-שלבי מופעל כדי לספק אבטחת ענן נוספת של UNIVAULTOFFICE. הזן את מספר הטלפון הנייד שלך כדי להמשיך לעבוד במשרד הענן. יש להזין את מספר הטלפון הנייד בפורמט בינלאומי עם קידומת מדינה.',
    ...
    emptySlide3Text: 'אחסן את המסמכים שלך בענן UNIVAULTOFFICE וגש אליהם בכל עת ומכל מקום.',
