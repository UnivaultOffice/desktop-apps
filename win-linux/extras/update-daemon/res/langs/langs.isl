...
en.CAPTION_TEXT =UNIVAULTOFFICE Update Service
en_GB.CAPTION_TEXT =UNIVAULTOFFICE Update Service
ru.CAPTION_TEXT =Сервис обновлений UNIVAULTOFFICE
ar_SA.CAPTION_TEXT =خدمة تحديث UNIVAULTOFFICE
de.CAPTION_TEXT =Aktualisierungsdienst von UNIVAULTOFFICE
es.CAPTION_TEXT =Servicio de actualización de UNIVAULTOFFICE
fr.CAPTION_TEXT =Service de mise à jour UNIVAULTOFFICE
it.CAPTION_TEXT =Servizio di aggiornamento UNIVAULTOFFICE
pt_BR.CAPTION_TEXT =Serviço de atualização UNIVAULTOFFICE
zh_CN.CAPTION_TEXT =UNIVAULTOFFICE 更新服务
bg.CAPTION_TEXT =UNIVAULTOFFICE Услуга за Актуализации
cs.CAPTION_TEXT =Aktualizační služba UNIVAULTOFFICE
el.CAPTION_TEXT =Υπηρεσία ενημέρωσης UNIVAULTOFFICE
fi.CAPTION_TEXT =UNIVAULTOFFICE Päivityspalvelu
hy.CAPTION_TEXT =UNIVAULTOFFICE-ի թարմացման ծառայություն
ko.CAPTION_TEXT =UNIVAULTOFFICE 업데이트 서비스
lv.CAPTION_TEXT =UNIVAULTOFFICE atjaunināšanas pakalpojums
nl.CAPTION_TEXT =UNIVAULTOFFICE Update Service
pl.CAPTION_TEXT =Usługa aktualizacji UNIVAULTOFFICE
pt_PT.CAPTION_TEXT =Serviço de atualização UNIVAULTOFFICE
sk.CAPTION_TEXT =Servis aktualizácie UNIVAULTOFFICE
sl.CAPTION_TEXT =Storitev posodabljanja UNIVAULTOFFICE
tr.CAPTION_TEXT =UNIVAULTOFFICE Güncelleme Hizmeti
uk.CAPTION_TEXT =Служба оновлень UNIVAULTOFFICE
vi.CAPTION_TEXT =Dịch vụ Cập nhật UNIVAULTOFFICE
sr_Latn_RS.CAPTION_TEXT =UNIVAULTOFFICE servis ažuriranja
si.CAPTION_TEXT =ඔන්ලිඔෆිස් යාවත්කාල සේවාව
be.CAPTION_TEXT =Сэрвіс абнаўлення UNIVAULTOFFICE
ca.CAPTION_TEXT =Servei d'actualitzacions UNIVAULTOFFICE
da.CAPTION_TEXT =UNIVAULTOFFICE Opdateringstjeneste
gl.CAPTION_TEXT =Servizo de actualización de UNIVAULTOFFICE
hu.CAPTION_TEXT =UNIVAULTOFFICE Frissítési Szolgáltatás
id.CAPTION_TEXT =Layanan Update UNIVAULTOFFICE
no.CAPTION_TEXT =UNIVAULTOFFICE oppdateringstjeneste
et.CAPTION_TEXT =UNIVAULTOFFICE värskendusteenus
lt.CAPTION_TEXT =UNIVAULTOFFICE atnaujinimo paslauga
hr.CAPTION_TEXT =Usluga ažuriranja UNIVAULTOFFICE
hi.CAPTION_TEXT =ओनलीऑफिस अपडेट सेवा
sv.CAPTION_TEXT =UNIVAULTOFFICE uppdateringstjänst
sr_Cyrl_RS.CAPTION_TEXT =UNIVAULTOFFICE Сервис ажурирања
he.CAPTION_TEXT =שירות העדכון של UNIVAULTOFFICE
sq.CAPTION_TEXT =Shërbimi i përditësimit UNIVAULTOFFICE
ur.CAPTION_TEXT =UNIVAULTOFFICE اپ ڈیٹ سروس
